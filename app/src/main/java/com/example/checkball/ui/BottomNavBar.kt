...
sealed class BottomNavItem(val route: String, val icon: ImageVector, val label: String) {
    data object Home : BottomNavItem("main", Icons.Default.Home, "Home")
    data object History : BottomNavItem("gameDetails", Icons.Default.Info, "History")
    data object CommunityFeed : BottomNavItem("communityFeed", Icons.AutoMirrored.Filled.List, "Highlights")
